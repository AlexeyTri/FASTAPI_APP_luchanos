...
# после первого запуска обязательно поменять креденшлс тестовой базы в alembic и env
...
async def clear_tables(async_session_test):
    """Clear data in all tables before running test function"""
